...
const Skills: FunctionComponent = () => {
  return (
    <Section className={styles.ic__skills}>
      <Container>
        <Heading className={styles.ic__skills__heading} heading={2}>
          Specialised in
        </Heading>
        <div className={styles.ic__skills__row}>
          ...
          <div className={styles.ic__skills__content}>
            <div className={styles.ic__skills__content__logo}>
              <Image
                src={'/assets/icons/webflow-logo-white.svg'}
                alt='webflow'
                height='180'
                width='180'
                objectFit='contain'
